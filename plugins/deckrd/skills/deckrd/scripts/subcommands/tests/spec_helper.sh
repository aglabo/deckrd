#!/usr/bin/env bash
# spec_helper.sh - ShellSpec helper for deckrd subcommands scripts
#
...
# ============================================================================
# Common setup for all deckrd subcommands spec files
# ============================================================================
# Usage in spec files:
#   Include spec_helper.sh   (shellspec DSL)
# ============================================================================

# Path to the subcommands directory (relative to this spec_helper)
# SHELLSPEC_PROJECT_ROOT is the project root set by shellspec
_SPEC_DIR="$(cd "${SHELLSPEC_PROJECT_ROOT}/plugins/deckrd/skills/deckrd/scripts/subcommands/tests" && pwd)"
# shellcheck disable=SC2034
SCRIPTS_DIR="${_SPEC_DIR}/../.."
# shellcheck disable=SC2034
SUBCOMMANDS_DIR="${_SPEC_DIR}/.."
unset _SPEC_DIR
