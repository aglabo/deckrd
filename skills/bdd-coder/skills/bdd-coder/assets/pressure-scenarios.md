...
These scenarios test whether bdd-coder follows BDD discipline under realistic pressure.
...
- Distinguish between local refactor (bdd-coder scope) and global refactor (bdd-coder Step 7)
